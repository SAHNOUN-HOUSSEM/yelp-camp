...
async function seedDB() {
    ...
    for (let i = 0; i < 1000; i++) {
        ...
        const point = { type: "Point", coordinates: [city.longitude, city.latitude] }
        const campgound = new Campground({
            title: `${returnRandomElt(descriptors, descriptorsLength)} ${returnRandomElt(places, placesLength)}`,
            location: `${city.city}, ${city.state}`,
            description: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Nemo asperiores unde qui natus error tempore sint fuga fugiat, repudiandae placeat. Temporibus quis nostrum eos esse eum explicabo vero quidem culpa?lo",
            point,
            price,
